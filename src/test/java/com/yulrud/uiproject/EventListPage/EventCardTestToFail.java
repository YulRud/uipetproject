...
public class EventCardTestToFail extends BaseTest {
    ...
    //Task 2
    @Test(description = "TO FAIL: Check upcoming card's fields are located in the correct order")
    ...
    @Test(description = "TO FAIL: Check first upcoming card's fields have correct values")
